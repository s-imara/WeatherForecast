...
public class DatabaseManager{
    ...
    public DatabaseManager(Context context){
        ...
        try {
            ...
            createQuery(query,ICON_URL, "TEXT" , false);
    ...
    public void addDataToDatabase (ArrayList<WeatherModel> models) {
        if (db.isOpen()) {
            for (int i = 0; i < models.size(); i++) {
                ...
                values.put(ICON_URL, models.get(i).getIconUrl().toString());
                ...
                if (cursor.moveToFirst()) {
                    do {
                       WeatherModel model = new WeatherModel();
                        ...
                        try {
                            model.setIconUrl(new URL(cursor.getString(cursor.getColumnIndex(ICON_URL))));
                        }
